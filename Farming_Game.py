...
def main(active_user='Guest'):
    ...
    while True:
        ...
        while True:
            ...
            while True:
                if keyboard.is_pressed('w') or keyboard.is_pressed('up'):
                    if end_time-start_time >= movement_time or start_time is None:
                        start_time = time.monotonic()
                        if player_position[0]-1 in range(map_height) and old_position[0] != player_position[0]+1:
                    ...
                    if end_time-start_time >= movement_time or start_time is None:
                        start_time = time.monotonic()
                        if player_position[1]-1 in range(map_width) and old_position[1] != player_position[1]+1:
                            old_position = player_position
            ...
            if old_position is not None and old_position != player_position:
